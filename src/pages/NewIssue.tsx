  ...
  return (
    <div className="max-w-2xl mx-auto">
      <div className="mb-8">
        ...
        <p className="text-slate-500">Completa el formulario para registrar un nuevo problema operativo.</p>
      </div>
      ...
      >
        ...
        <div className="space-y-2">
          <label className="text-sm font-medium text-slate-700">Título del Problema</label>
          <input
            required
            type="text"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="space-y-2">
            <label className="text-sm font-medium text-slate-700">Área Afectada</label>
            <select
              required
              className="w-full px-4 py-3 rounded-xl border border-slate-200 focus:ring-2 focus:ring-blue-500 outline-none transition-all"
        ...
        <div className="space-y-2">
          ...
          <textarea
            ...
            placeholder="Describe qué ocurrió, quién lo detectó y el impacto inmediato..."
        ...
        <div className="pt-4 flex gap-4">
          <button
            ...
            className="flex-1 py-4 px-6 rounded-xl font-semibold text-slate-600 border border-slate-200 hover:bg-slate-50 transition-all"
          >
            Cancelar
          </button>
          <button
            type="submit"
            disabled={loading}
            className="flex-[2] py-4 px-6 rounded-xl font-semibold bg-blue-600 text-white hover:bg-blue-700 transition-all shadow-lg shadow-blue-200 flex items-center justify-center gap-2 disabled:opacity-50"
          >
            {loading ? (
